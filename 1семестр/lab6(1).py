...
# Радиокомпания провела опрос слушателей по вопросу: «Кого вы считаете человеком года?». Определить пять наиболее часто встречаю- щихся ответов и их долей (в процентах от общего количества ответов).
...
print("Пять часто встречаюшихся ответов и их процент относительно остальных ответов:")
for g in golos:
    if g >= golos[4]:
        for prov in dop:
            if prov == g:
